...
def f_load():
    try:
        ...
        from src.instinctive_diffuse.baseline import generate
...
def main(page: ft.Page):
    ...
    tool_tip = ft.Container(ft.Tooltip(
        message="Using StableGan is easiest possible thing just write the text in Text field and get image Done !",
