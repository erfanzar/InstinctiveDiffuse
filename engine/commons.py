...
class GeneratorBlock(M):
    def __init__(self, in_size, out_size, k: int = 3, s: int = 1, fl: bool = False, act: typing.Union[str] = None):
        ...
        self.m = nn.Sequential(
            Conv(in_size, out_size, k=k, s=s, activation=act, using_bn=True),
        ) if not fl else nn.Sequential(
            Conv(in_size, out_size, k=k, s=s, activation=act, using_bn=False),
        )
...
class DiscriminatorBlock(M):
    def __init__(self, in_size, out_size, k: int = 3, s: int = 1, fl: bool = False, act: typing.Union[str] = None):
        ...
        self.m = nn.Sequential(
            Conv(in_size, out_size, k=k, s=s, activation=act, using_bn=True, batch_first=True),
        ) if not fl else nn.Sequential(
            Conv(in_size, out_size, k=k, s=s, activation=act, using_bn=False, batch_first=True),
        )
